...
import mjml2html, { components, initializeType } from 'mjml-core-4-terser'
import migrate from 'mjml-migrate-4-terser'
import validate, { dependencies } from 'mjml-validator-4-terser'
import MJMLParser from 'mjml-parser-xml-4-terser'

import { version as coreVersion } from 'mjml-core-4-terser/package.json'
